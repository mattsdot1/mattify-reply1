...
bot.on("guildMemberAdd", function (member){
	member.send("Welcome to The Server! I am Mattify Reply, Created by Mattify#3675! You can say ?help to view all of my amazing and fun commands! More are being added! Oh, and Please Make Sure To Read the " + member.guild.channels.find("name","rules") + " and enjoy your stay here and don't forget to invite friends! :wink:");
